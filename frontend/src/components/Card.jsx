...
export default function Card(props) {
  ...
  const handleAddToCart = async () => {
    ...
    if (food.length !== 0) {
      if (food.size === size) {
        ...
        await dispatch({ type: "ADD", id: foodItem._id, name: foodItem.name, price: finalPrice, qty: qty, size: size,img: props.img })
  ...
  return (
    <div>
      <div className="card my-3" style={{ width: "16rem", maxHeight: "360px" }}>
